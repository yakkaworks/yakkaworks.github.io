...
function renderNavbar() {
  ...
  mount.innerHTML = `
    <nav class="navbar" style="background-color: var(--bs-primary);">
    ...
    <div class="offcanvas offcanvas-end" tabindex="-1" id="yw-offcanvas" aria-labelledby="yw-offcanvas-label">
...
function renderFooter() {
  ...
  mount.innerHTML = `
    <footer class="text-white py-5 mt-5" style="background-color: var(--bs-primary);">
      <div class="container">
        <div class="row gy-4">
          <div class="col-12 col-md-4">
            <a href="/" class="d-flex align-items-center gap-2 text-white text-decoration-none mb-2">
          ...
          <div class="col-6 col-md-4">
            ...
            <ul class="list-unstyled small">
              ...
              <li class="mb-2"><a href="/license.html" class="text-white text-decoration-none">License</a></li>
              <li class="mb-2"><a href="https://github.com/yakkaworks" class="text-white text-decoration-none">Source Code</a></li>
            </ul>
          </div>
          ...
          <div class="col-6 col-md-4">
            ...
            <div class="d-flex gap-3 fs-5 mb-3">
              <a href="https://facebook.com/yakkaworks" class="text-white" aria-label="Facebook"><i class="bi bi-facebook"></i></a>
              <a href="https://youtube.com/@yakkaworks" class="text-white" aria-label="YouTube"><i class="bi bi-youtube"></i></a>
              <a href="https://github.com/yakkaworks" class="text-white" aria-label="GitHub"><i class="bi bi-github"></i></a>
              <a href="https://x.com/yakkaworks" class="text-white" aria-label="X"><i class="bi bi-twitter-x"></i></a>
              <a href="https://instagram.com/yakkaworks" class="text-white" aria-label="Instagram"><i class="bi bi-instagram"></i></a>
            </div>
            <a href="mailto:yakkaworks@gmail.com" class="text-white small text-decoration-none d-block">
